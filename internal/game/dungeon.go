	...
	return [7]*BossMat{
		{
			...
			SpecialAbilities: []DungeonCard{
				...
				&CurseCard{Id: nextCardId(), Type: ChallengeCurse, Name: "Cursed Blocks", Effect: HandSizeLimitedToThree},
				&CurseCard{Id: nextCardId(), Type: ChallengeCurse, Name: "Rattle of Time", Effect: TimeCannotBeStopped},
			},
		},
		{
			Id:        nextCardId(),
			...
			SpecialAbilities: []DungeonCard{
				&EventCard{
					Id: nextCardId(), Type: ChallengeEvent, Name: "Acid Polish", Action: &AcidPolishEvent{}},
				&EventCard{
					Id: nextCardId(), Type: ChallengeEvent, Name: "Waxed Floor", Action: &WaxedFloorEvent{}},
				&MiniBossCard{
					Id: nextCardId(), Type: ChallengeMiniBoss, Name: "Reaper Jr.", Resources: []ResourceType{Sword, Sword, Jump, Arrow, Arrow, Arrow}},
				&CurseCard{Id: nextCardId(), Type: ChallengeCurse, Name: "Waffles Waffles !", Effect: PlayersMustOnlySayWaffles},
				&CurseCard{Id: nextCardId(), Type: ChallengeCurse, Name: "Waffles Waffles !", Effect: PlayersMustOnlySayWaffles},
			},
		},
		{
			...
			SpecialAbilities: []DungeonCard{
				&EventCard{
					Id: nextCardId(), Type: ChallengeEvent, Name: "Corrosive Spit", Action: &CorrosiveSpitEvent{}},
				&EventCard{
					Id: nextCardId(), Type: ChallengeEvent, Name: "Ensnared!", Action: &EnsnaredEvent{}},
				&EventCard{
					Id: nextCardId(), Type: ChallengeEvent, Name: "My Swords!", Action: &MySwordsEvent{}},
				&CurseCard{Id: nextCardId(), Type: ChallengeCurse, Name: "Cursed Cosplayers", Effect: FlippedHeroMat,
				...
				&CurseCard{Id: nextCardId(), Type: ChallengeCurse, Name: "Gorgon's Gaze", Effect: AbilitiesCannotBePlayed},
			},
		},
		{
			Id:        nextCardId(),
			...
			SpecialAbilities: []DungeonCard{
				&EventCard{
					Id: nextCardId(), Type: ChallengeEvent, Name: "Fire Breath", Action: &FireBreathEvent{}},
				&EventCard{
					Id: nextCardId(), Type: ChallengeEvent, Name: "Tail Swipe", Action: &TailSwipeEvent{}},
				&EventCard{
					Id: nextCardId(), Type: ChallengeEvent, Name: "Tail Swipe", Action: &TailSwipeEvent{}},
				&CurseCard{Id: nextCardId(), Type: ChallengeCurse, Name: "Blinding Light", Effect: HandsHidden},
				&CurseCard{Id: nextCardId(), Type: ChallengeCurse, Name: "Endless Ambush", Effect: DoorsOpenInPairs},
			},
		},
		{
			Id:        nextCardId(),
			...
			SpecialAbilities: []DungeonCard{
				&EventCard{
					Id: nextCardId(), Type: ChallengeEvent, Name: "A 20-Sided Boulder", Action: &ATwentySidedBoulderEvent{}},
				&MiniBossCard{
					Id: nextCardId(), Type: ChallengeMiniBoss, Name: "\"Dungeon Master\"", Resources: []ResourceType{Jump, Jump, Shield, Shield, Shield}, Extension: true},
				&MiniBossCard{
					Id: nextCardId(), Type: ChallengeMiniBoss, Name: "The Necro-Nom-Icon", Resources: []ResourceType{Scroll, Scroll, Scroll, Scroll, Scroll}, Extension: true},
				&CurseCard{Id: nextCardId(), Type: ChallengeCurse, Name: "Clock Blocked", Effect: TimeCannotBeStopped},
				&CurseCard{Id: nextCardId(), Type: ChallengeCurse, Name: "Sheepified!", Effect: ActionsCannotBePlayed},
			},
		},
		{
			Id:               nextCardId(),
		...
		},
		{
			...
			SpecialAbilities: []DungeonCard{
				&CurseCard{Id: nextCardId(), Type: ChallengeCurse, Name: "A Boot-Alion of Kittens", Effect: PlayersMustOnlySayMeow},
				&CurseCard{Id: nextCardId(), Type: ChallengeCurse, Name: "Conga-Rats!", Effect: ThreeDiscardsWhenTimeStops,
					Cure: func(ctx Context) ([]Event, error) {
				...
				&EventCard{
					Id: nextCardId(), Type: ChallengeEvent, Name: "Feeding the Trolls"},
				&CurseCard{Id: nextCardId(), Type: ChallengeCurse, Name: "House Rules!", Effect: PlayersHandFacingAway},
				&EventCard{
					Id: nextCardId(), Type: ChallengeEvent, Name: "The Early Bird"},
			},
		},
	}
}
